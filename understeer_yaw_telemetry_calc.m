function [understeer_angle_deg, yaw_rate_theory_rads, K_us_scalar_deg_g, K_us_inst_deg_g] = understeer_yaw_telemetry_calc(steer_wheel_deg, steering_ratio, speed_ms, wheelbase_m, lat_accel_ms2)
% understeer_yaw_calc calculates instantaneous and scalar understeer gradients and theoretical yaw rate
    ...
    yaw_rate_theory_rads = (speed_ms .* road_wheel_rad) ./ (wheelbase_m + (K_us_scalar_SI .* (speed_ms .^ 2)));
end